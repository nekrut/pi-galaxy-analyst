...
export type Cache =
  ...
  | { fetchedAt: number; failed?: false; latest: string; channel: string; orbitLatest?: string };
...
export function fetchOrbitLatest(fetchFn?: typeof fetch): Promise<string | null>;
